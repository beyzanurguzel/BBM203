...
public:
    ...
    /*// to check whether 2 vectors are equal
    static bool areEqual(const std::vector<std::vector<bool>>&, const std::vector<std::vector<bool>>&);

    // to rotate shape of the celestial objects
    void rotate(CelestialObject*, bool);
    */
};
